 ...
 *
 * Note that these lists do not the same iterator policy as Java's ArrayLists. In particular, "The
 * iterators returned by this class's iterator and listIterator methods are fail-fast: if the list
